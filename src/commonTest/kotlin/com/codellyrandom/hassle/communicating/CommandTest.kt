        ...
        CommandImpl::class.sealedSubclasses.forEach { commandClass: KClass<out CommandImpl> ->
            when (commandClass) {
                ...
                ServiceCommand::class -> {
                    ServiceCommand::class.sealedSubclasses.forEach { serviceCommandClass: KClass<out ServiceCommand> ->
                        when (serviceCommandClass) {
                            ...
                            TurnOnServiceCommand::class -> {
                                ...
                                fail("No test for class $serviceCommandClass")
                            }
                        }
                    }
                }
